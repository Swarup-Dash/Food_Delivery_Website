            ...
            <div className="xl:mx-auto xl:w-full xl:max-w-sm 2xl:max-w-md border 1px solid bg-transparent border-double">
              ...
              <p className="mt-2 text-center text-sm from-white ">
                ...
                <a
                  href="#"
                  title=""
                  className="font-extrabold text-cyan-400 transition-all duration-200 hover:underline"
                >
            <Link to="/register">Create a free account</Link>
                </a>
              </p>
              <form action="#" method="POST" className="mt-8 text-center">
                <div className="space-y-5">
                  <div>
                    <label for="" className="text-base font-medium white">
                      {" "}
                      Email address{" "}
                    </label>
                    <div className="mt-2">
